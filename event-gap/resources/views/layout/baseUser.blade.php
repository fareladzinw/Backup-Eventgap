...
<body style="color :black">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand w-50" href="{{ url('/dashboard')}}">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item b-green">
                        @if(Auth::user()->status_validasi == 1)
                        <a href="{{ url('/make-event') }}" class="nav-link c-green">Make an Event</a>
                        @else
                         <a href="" class="nav-link c-green"  onClick="alert('Harap Verifikasi Akun Terlebih dahulu')">Make an Event</a>
                        @endif
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/my-profile') }}" class="nav-link c-grey">Your Profile</a>
                    </li>
                    <li class="nav-item">
